...
export default function ProfilePage({ params }: ProfilePageProps) {
  ...
  // Check if we should open the developer modal from URL parameter
  useEffect(() => {
    if (searchParams.get('openDeveloper') === 'true' && !userProfile?.isDeveloper) {
        ...
        <div className="lg:col-span-2 flex flex-col gap-6 h-full">
          ...
          <div className="bg-gray-800/50 backdrop-blur-md rounded-2xl border border-gray-700/50 p-6 shadow-xl">
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              className="flex flex-col items-center p-4 bg-gray-700/30 rounded-xl hover:bg-purple-600/20 transition-all duration-300 group">
